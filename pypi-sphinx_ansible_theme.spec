...
Version  : 0.10.2
Release  : 14
URL      : https://files.pythonhosted.org/packages/d4/0d/dd2e58221fa2fcd3aef54ef49f1c2c3bc1c723c9a4fb53dac9af2bb8253c/sphinx-ansible-theme-0.10.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/d4/0d/dd2e58221fa2fcd3aef54ef49f1c2c3bc1c723c9a4fb53dac9af2bb8253c/sphinx-ansible-theme-0.10.2.tar.gz
...
%prep
%setup -q -n sphinx-ansible-theme-0.10.2
cd %{_builddir}/sphinx-ansible-theme-0.10.2
pushd ..
cp -a sphinx-ansible-theme-0.10.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700611348
