...
Version  : 0.10.0
Release  : 9
URL      : https://files.pythonhosted.org/packages/b2/0a/71724e6b879350b3edeeddd517c00c4a820da68a4eba440208072d382b4f/sphinx-ansible-theme-0.10.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/b2/0a/71724e6b879350b3edeeddd517c00c4a820da68a4eba440208072d382b4f/sphinx-ansible-theme-0.10.0.tar.gz
...
%prep
%setup -q -n sphinx-ansible-theme-0.10.0
cd %{_builddir}/sphinx-ansible-theme-0.10.0
pushd ..
cp -a sphinx-ansible-theme-0.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668097055
